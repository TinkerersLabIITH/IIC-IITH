    ...
    return(
        <Fragment>
            ...
            <div className="container-fluid">
                <div className="row" style={{ padding: '0px 15px 20px' }}>
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="image-wrapper" style={{ paddingBottom: '10px' }}>
                            <img src={pic2} className="shadow" alt="Mohamed Kaif"
                                style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', borderRadius: '50%', width: '200px', height: '200px' }} />
                        </div>
                        <h6 className="text-center">Mohamed Kaif D</h6>
                        <h6 className="text-center">Industrial Chemistry<br />IIT Hyderabad</h6>
