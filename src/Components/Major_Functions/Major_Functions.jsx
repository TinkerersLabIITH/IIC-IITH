        ...
        <div className="container">
          ...
          <div className="row">
              ...
              <div className="container">
                ...
                <p className="lead">
                  <ul>
                    ...
                    <li>Prepare institute for Atal Ranking of Institutions on Innovation Achievements Framework (ARIIA).</li>
            ...
            <div className="col-lg-4">
              <img src={Ratingpic} style={{ width: "100%" }} alt="Rating Certificate" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.sectionpadding} id="functions">
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <img src={Establishment} style={{ width: "100%" }} alt="Establishment Certificate" />
            </div>
          </div>
        </div>
      </section>
